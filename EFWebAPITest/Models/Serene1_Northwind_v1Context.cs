...
namespace EFWebAPITest.Models
{
    ...
    //public class Serene1_Northwind_v1ContextFactory : IDesignTimeDbContextFactory<Serene1_Northwind_v1Context>
    //{
    //    public Serene1_Northwind_v1Context CreateDbContext(string[] args)
    //    {
    //        var optionsBuilder = new DbContextOptionsBuilder<Serene1_Northwind_v1Context>();
    //        optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=Serene1_Northwind_v1;Trusted_Connection=True;");
    //        return new Serene1_Northwind_v1Context(optionsBuilder.Options);
    //    }
    //}

    public partial class Serene1_Northwind_v1Context : DbContext
    {
        public Serene1_Northwind_v1Context(DbContextOptions<Serene1_Northwind_v1Context> options) : base(options)
        {
        }
