...
namespace EFWebAPITest.Controllers
{
    ...
    {
        private readonly Serene1_Northwind_v1Context _context;

        public OrdersController(Serene1_Northwind_v1Context context)
        {
            _context = context;    
        }
        ...
        {
            var serene1_Northwind_v1Context = _context.Orders.Include(o => o.Customer).Include(o => o.Employee).Include(o => o.ShipViaNavigation);
            return View(await serene1_Northwind_v1Context.ToListAsync());
        }
